...
//load adresses
export const FETCH_ADRESSES_REQUESTED = "FETCH_ADRESSES_REQUESTED";
export const FETCH_ADRESSES_SUCCESS = "FETCH_ADRESSES_SUCCESS";
export const FETCH_ADRESSES_FAILURE = "FETCH_ADRESSES_FAILURE";