...
//_______________________SSJKU_________________________

//load standardcategories
export const FETCH_STANDARD_CATEGORIES_REQUESTED = "FETCH_STANDARD_CATEGORIES_REQUESTED";
...
//load housetypes
export const FETCH_HOUES_TYPES_REQUESTED = "FETCH_HOUES_TYPES_REQUESTED";
export const FETCH_HOUES_TYPES_SUCCESS = "FETCH_HOUES_TYPES_SUCCESS";
export const FETCH_HOUES_TYPES_FAILURE = "FETCH_HOUES_TYPES_FAILURE";

//load standards
export const FETCH_STANDARDS_REQUESTED = "FETCH_STANDARDS_REQUESTED";
export const FETCH_STANDARDS_SUCCESS = "FETCH_STANDARDS_SUCCESS";
export const FETCH_STANDARDS_FAILURE = "FETCH_STANDARDS_FAILURE";

//Addeting standard
export const ADDETING_STANDARDS_REQUESTED = "ADDETING_STANDARDS_REQUESTED";
export const ADDETING_STANDARDS_SUCCESS = "ADDETING_STANDARDS_SUCCESS";
export const ADDETING_STANDARDS_FAILURE = "ADDETING_STANDARDS_FAILURE";

//Delete standard
export const DELETE_STANDARDS_REQUESTED = "DELETE_STANDARDS_REQUESTED";
export const DELETE_STANDARDS_SUCCESS = "DELETE_STANDARDS_SUCCESS";
export const DELETE_STANDARDS_FAILURE = "DELETE_STANDARDS_FAILURE";
...
//_______________________SERVICESCOMMUNAL_________________________

//load servicescommunal
export const FETCH_SERVICES_COMMUNAL_REQUESTED = "FETCH_SERVICES_COMMUNAL_REQUESTED";
export const FETCH_SERVICES_COMMUNAL_SUCCESS = "FETCH_SERVICES_COMMUNAL_SUCCESS";
export const FETCH_SERVICES_COMMUNAL_FAILURE = "FETCH_SERVICES_COMMUNAL_FAILURE";

//Addeting item in servicescommunal
export const ADDETING_SERVICES_COMMUNAL_REQUESTED = "ADDETING_SERVICES_COMMUNAL_REQUESTED";
export const ADDETING_SERVICES_COMMUNAL_SUCCESS = "ADDETING_SERVICES_COMMUNAL_SUCCESS";
export const ADDETING_SERVICES_COMMUNAL_FAILURE = "ADDETING_SERVICES_COMMUNAL_FAILURE";

//Editing item in servicescommunal
export const EDITING_SERVICES_COMMUNAL_REQUESTED = "EDITING_SERVICES_COMMUNAL_REQUESTED";
export const EDITING_SERVICES_COMMUNAL_SUCCESS = "EDITING_SERVICES_COMMUNAL_SUCCESS";
export const EDITING_SERVICES_COMMUNAL_FAILURE = "EDITING_SERVICES_COMMUNAL_FAILURE";

//Delete servicescommunal
export const DELETE_SERVICES_COMMUNAL_REQUESTED = "DELETE_SERVICES_COMMUNAL_REQUESTED";
export const DELETE_SERVICES_COMMUNAL_SUCCESS = "DELETE_SERVICES_COMMUNAL_SUCCESS";
export const DELETE_SERVICES_COMMUNAL_FAILURE = "DELETE_SERVICES_COMMUNAL_FAILURE";